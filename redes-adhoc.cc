...
*   Os tipos 1 e 2 tem 5 nós filhos, 3 e 4, 17 nós filhos, 5 e 6, 30 nós filhos.
*
...
int main (int argc, char *argv[]){
    ...
    if (arvore == 1){
        positionAlloc->Add (Vector (10.0, 40.0, 00.0));
        positionAlloc->Add (Vector (10.0, 30.0, 00.0));
        positionAlloc->Add (Vector (10.0, 20.0, 00.0));
        positionAlloc->Add (Vector (10.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0, 00.0, 00.0));
        positionAlloc->Add (Vector (20.0, 00.0, 00.0));
    }else if (arvore == 2){
        positionAlloc->Add (Vector (20.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0, 00.0, 00.0));
        positionAlloc->Add (Vector (10.0, 00.0, 00.0));
        positionAlloc->Add (Vector (20.0, 00.0, 00.0));
        positionAlloc->Add (Vector (30.0, 00.0, 00.0));  
        positionAlloc->Add (Vector (40.0, 00.0, 00.0));  
    }else if (arvore == 3){
        positionAlloc->Add (Vector (60.0,  40.0, 00.0));
        positionAlloc->Add (Vector (60.0,  30.0, 00.0));
        positionAlloc->Add (Vector (60.0,  20.0, 00.0));
        positionAlloc->Add (Vector (20.0,  10.0, 00.0));
        positionAlloc->Add (Vector (60.0,  10.0, 00.0));
        positionAlloc->Add (Vector (100.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0,  00.0, 00.0));
        positionAlloc->Add (Vector (10.0,  00.0, 00.0));
        positionAlloc->Add (Vector (20.0,  00.0, 00.0));
        positionAlloc->Add (Vector (30.0,  00.0, 00.0));
        positionAlloc->Add (Vector (40.0,  00.0, 00.0));
        positionAlloc->Add (Vector (50.0,  00.0, 00.0));
        positionAlloc->Add (Vector (60.0,  00.0, 00.0));
        positionAlloc->Add (Vector (70.0,  00.0, 00.0));
        positionAlloc->Add (Vector (80.0,  00.0, 00.0));
        positionAlloc->Add (Vector (90.0,  00.0, 00.0));
        positionAlloc->Add (Vector (100.0, 00.0, 00.0));
        positionAlloc->Add (Vector (110.0, 00.0, 00.0));
    }else if (arvore == 4){
        positionAlloc->Add (Vector (70.0,  20.0, 00.0));
        positionAlloc->Add (Vector (10.0,  10.0, 00.0));
        positionAlloc->Add (Vector (40.0,  10.0, 00.0));
        positionAlloc->Add (Vector (70.0,  10.0, 00.0));
        positionAlloc->Add (Vector (100.0, 10.0, 00.0));
        positionAlloc->Add (Vector (130.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0,  00.0, 00.0));
        positionAlloc->Add (Vector (20.0,  00.0, 00.0));
        positionAlloc->Add (Vector (30.0,  00.0, 00.0));
        positionAlloc->Add (Vector (40.0,  00.0, 00.0));
        ...
        positionAlloc->Add (Vector (100.0, 00.0, 00.0));
        positionAlloc->Add (Vector (110.0, 00.0, 00.0));
        positionAlloc->Add (Vector (120.0, 00.0, 00.0));
        positionAlloc->Add (Vector (140.0, 00.0, 00.0));
    }else if(arvore == 5){
        positionAlloc->Add (Vector (120.0, 40.0, 00.0));
        positionAlloc->Add (Vector (120.0, 30.0, 00.0));
        positionAlloc->Add (Vector (120.0, 20.0, 00.0));
        positionAlloc->Add (Vector (20.0,  10.0, 00.0));
        positionAlloc->Add (Vector (70.0,  10.0, 00.0));
        positionAlloc->Add (Vector (120.0, 10.0, 00.0));
        positionAlloc->Add (Vector (170.0, 10.0, 00.0));
        positionAlloc->Add (Vector (210.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0,  00.0, 00.0));
        positionAlloc->Add (Vector (10.0,  00.0, 00.0));
        positionAlloc->Add (Vector (20.0,  00.0, 00.0));
        positionAlloc->Add (Vector (30.0,  00.0, 00.0));
        ...
        positionAlloc->Add (Vector (110.0, 00.0, 00.0));
        positionAlloc->Add (Vector (120.0, 00.0, 00.0));
        positionAlloc->Add (Vector (130.0, 00.0, 00.0));
        positionAlloc->Add (Vector (140.0, 00.0, 00.0)); 
        positionAlloc->Add (Vector (150.0, 00.0, 00.0));
        positionAlloc->Add (Vector (160.0, 00.0, 00.0));
        positionAlloc->Add (Vector (170.0, 00.0, 00.0));
        positionAlloc->Add (Vector (180.0, 00.0, 00.0));
        positionAlloc->Add (Vector (190.0, 00.0, 00.0));
        positionAlloc->Add (Vector (200.0, 00.0, 00.0));
        positionAlloc->Add (Vector (210.0, 00.0, 00.0));
        positionAlloc->Add (Vector (220.0, 00.0, 00.0));        
    }else if(arvore==6){
        positionAlloc->Add (Vector (120.0, 20.0, 00.0));
        positionAlloc->Add (Vector (20.0,  10.0, 00.0));
        positionAlloc->Add (Vector (70.0,  10.0, 00.0));
        positionAlloc->Add (Vector (120.0, 10.0, 00.0));
        positionAlloc->Add (Vector (170.0, 10.0, 00.0));
        positionAlloc->Add (Vector (220.0, 10.0, 00.0));
        positionAlloc->Add (Vector (00.0,  00.0, 00.0));
        positionAlloc->Add (Vector (10.0,  00.0, 00.0));
        positionAlloc->Add (Vector (20.0,  00.0, 00.0));
        positionAlloc->Add (Vector (30.0,  00.0, 00.0));
        ...
        positionAlloc->Add (Vector (210.0, 00.0, 00.0));
        positionAlloc->Add (Vector (220.0, 00.0, 00.0));
        positionAlloc->Add (Vector (230.0, 00.0, 00.0));
        positionAlloc->Add (Vector (240.0, 00.0, 00.0));                 
    }
